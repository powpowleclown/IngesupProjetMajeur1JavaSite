...
public class IncidentRest {
	...
	public Response getMaRessourceParId(@PathParam("id") String id) {
		...
		return Response.ok((IncidentDAO.getIncident(Integer.parseInt(id)))).build();
	}

	@POST
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response createMaRessource(Incident incident) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response updateMaRessource(@PathParam("id") String id, Incident incident) {
	...
	public Response deleteMaRessource(@PathParam("id") String id) {
		...
		IncidentDAO.DeleteIncidentById(Integer.parseInt(id));
